...
export class UserCoursesMapping implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get('/user-courses/Without-complation', AuthMiddleware, this.userCoursesMappingController.findAllWithoutComplation);
    this.router.get('/user-courses/:slug', this.userCoursesMappingController.findCourseUsers);
