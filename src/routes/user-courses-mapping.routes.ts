...
export class UserCoursesMapping implements Routes {
  ...
  private initializeRoutes() {
    this.router.post('/user-courses-mappings', AuthMiddleware, this.userCoursesMappingController.create);
    this.router.get('/user-courses-mappings', AuthMiddleware, this.userCoursesMappingController.findAll);
