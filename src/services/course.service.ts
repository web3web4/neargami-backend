...
import { PrismaClient, Course, User, Prisma, SearchQuery, courseStatusHistoryForAdmin } from "@prisma/client"
...
export class CourseService {
  ...
  private courseStatusLogForAdmin = this.prismaService.courseStatusHistoryForAdmin;
